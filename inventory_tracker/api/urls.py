...
from .views import ItemView, AddOrUpdateItemView, GetItemView, DeleteItemView
...
urlpatterns = [
    ...
    path('delete-item/', DeleteItemView.as_view()),       # delete item e.g. http://127.0.0.1:8000/api/delete-item/?id=5
]